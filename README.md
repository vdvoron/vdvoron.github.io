...
This project shows the full development process of an Android app from a simple starting version to a complete, stable, and well-structured product. Each enhancement focused on a different area of improvement —testing, performance, and database design, showing my ability to apply software engineering, data management, and algorithmic thinking in real development work. The main branch now serves as a professional portfolio presentation of all those stages in one place.
